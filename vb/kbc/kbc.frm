...
Begin VB.Form frmform 
   ...
   Begin MCI.MMControl multi 
      ...
      DeviceType      =   ""
      FileName        =   "E:\programming\vb\kbc\frozen.wav"
   End
...
Private Sub lblhead_Click(Index As Integer)
...
Private Sub multi_Done(NotifyCode As Integer)
